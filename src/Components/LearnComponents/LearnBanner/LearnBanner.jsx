...
const LearnBanner = () => {
    return (
        <section className="pb-20">
            <div className="flex justify-between items-center 2xl:px-80 px-8">
                <div className="text-[#202839] space-y-4">
                    ...
                    <h2 className="xl:text-5xl lg:text-4xl font-bold">Web Developing <br /> <span className="text-red-500">Courses</span> And Resources</h2>
                ...
                <div className="relative">
                    <img className="xl:w-[570px] lg:w-[400px] xl:h-[570px] lg:h-[400px] bg-amber-500 rounded-full" src={`https://i.postimg.cc/xdDSkvJ5/Banner-Img-without-bg-2.png`} alt="" />
                    <div className="flex gap-5 absolute -bottom-24 right-0">
                        ...
                        <div className="bg-[#E54444] text-white xl:py-4 lg:py-3 px-4 xl:w-[200px] lg:w-[170px] space-y-2 flex  lg:items-start lg:hidden xl:block" style={{ borderRadius: '10px 2px 10px 10px' }}>
                            <div className="space-y-2">
