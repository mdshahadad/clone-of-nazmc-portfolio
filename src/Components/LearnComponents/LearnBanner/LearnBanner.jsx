        ...
        <section className="pb-20">
            <div className="flex justify-between items-center px-80">
                <div className="text-[#202839] space-y-4">
                    ...
                    <h2 className="text-5xl font-bold">Web Developing <br /> <span className="text-red-500">Courses</span> And Resources</h2>
                ...
                <div className="relative">
                    <img className="xl:w-[570px] lg:w-[450px] xl:h-[570px] lg:h-[450px] bg-amber-500 rounded-full" src={`https://i.postimg.cc/xdDSkvJ5/Banner-Img-without-bg-2.png`} alt="" />
