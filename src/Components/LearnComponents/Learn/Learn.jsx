    ...
    return (
        <section className="pt-16">
            ...
            <div id="#books" className="pb-20">
                ...
                2xl:px-[350px] xl:px-12 px-4 pb-16'>
                    ...
                    <div>
                        <button className='border-2 border-violet-600 px-12 py-4 font-semibold text-lg text-[#202839] lg:mt-0 mt-10' style={{ borderRadius: '8px 0px 8px 8px' }}>
