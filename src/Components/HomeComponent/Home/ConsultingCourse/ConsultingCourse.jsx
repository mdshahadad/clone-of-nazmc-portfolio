...
const ConsultingCourse = () => {
    return (
        <section className='consulting_gradient py-20'>
            <div className='flex justify-between items-center 2xl:px-80 xl:px-12 px-5 pb-8'>
                ...
                <div>
                    <button className='border-2 border-white px-8 py-3 font-semibold text-lg text-white' style={{borderRadius: '8px 0px 8px 8px'}}>
