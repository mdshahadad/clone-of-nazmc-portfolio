...
const BannerText = () => {
    return (
        <div className="text-white space-y-4 pt-8">
            <h1 className="text-[52px] leading-[62px] font-bold">Grow Your <span className="text-red-500">Business</span> And <br /> <span className="text-red-500">Skills</span> In Digital Marketing</h1>
