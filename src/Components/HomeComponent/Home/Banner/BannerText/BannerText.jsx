...
const BannerText = () => {
    return (
        <div className="text-white space-y-4 pt-8">
            <h1 className="xl:text-[54px] text-[42px] xl:leading-[62px] lg:leading-[48px] font-bold">Grow Your <span className="text-red-500">Business</span> And <br /> <span className="text-red-500">Skills</span> In Web Development</h1>
